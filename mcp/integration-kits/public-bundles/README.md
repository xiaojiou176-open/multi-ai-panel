...
- Codex and Claude Code:
  ...
  - no official AgentGangGang marketplace listing verified from current official docs
- OpenCode:
...
- OpenClaw:
  ...
  - no official AgentGangGang listing is verified from the checked OpenClaw docs
...
- root-level `agentganggang-*.tgz` files are disposable leftovers, not the
