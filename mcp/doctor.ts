...
export const createDoctorMessage = (bridgeBaseUrl: string, health: BridgeHealth) => ({
  ...
  extensionRequirement:
    'Load MultiAiPanel in Chromium with the unpacked extension enabled so the background bridge client can connect.',
  currentModel:
  ...
  startupOrder: [
    'npm run mcp:operator -- server',
    'load or reload the unpacked MultiAiPanel extension in Chromium',
