...
export const SettingsPanel: React.FC<SettingsProps> = ({ onClose }) => {
  ...
  const handleExport = () => {
    try {
      ...
      a.href = url;
      a.download = `multi-ai-panel-backup-${new Date().toISOString().slice(0, 10)}.json`;
              ...
              >
                ...
                <p className="mt-2 text-sm text-slate-600">
                  {t(
                    ...
                    'Use one local Switchyard service for the analysis lane while MultiAiPanel keeps compare, tabs, and workflow orchestration in the browser.'
                  )}
                </p>
              ...
              <p className="mt-1 text-sm text-slate-600">
                {usingRuntimeLane
                  ...
                  : t(
                      ...
                      'MultiAiPanel tries this tab first, then falls back to another ready model if needed.'
                    )}
              </p>
