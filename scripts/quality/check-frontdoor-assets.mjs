...
const assetSpecs = [
  {
    path: 'docs/assets/agentganggang-social-preview.png',
    type: 'png',
    width: 1280,
    height: 640,
    maxBytes: 1_000_000,
  ...
  {
    path: 'docs/assets/agentganggang-nav-icon.svg',
    type: 'svg',
    width: 128,
    height: 128,
    maxBytes: 10_000,
  ...
  {
    path: 'docs/assets/agentganggang-before-after.svg',
    type: 'svg',
    width: 1280,
    height: 780,
    maxBytes: 30_000,
  ...
  {
    path: 'docs/assets/agentganggang-hero.png',
    type: 'png',
    minWidth: 1600,
    minHeight: 900,
    maxBytes: 600_000,
  ...
  {
    path: 'docs/assets/agentganggang-compare-detail.png',
    type: 'png',
    minWidth: 1200,
    minHeight: 700,
    maxBytes: 400_000,
  ...
  {
    path: 'docs/assets/agentganggang-workflow-panel.png',
    type: 'png',
    minWidth: 1200,
    minHeight: 300,
    maxBytes: 250_000,
  ...
  {
    path: 'docs/assets/agentganggang-analyst-panel.png',
    type: 'png',
    minWidth: 1200,
    minHeight: 900,
    maxBytes: 250_000,
  ...
  {
    path: 'docs/assets/agentganggang-builder-surface.png',
    type: 'png',
    minWidth: 900,
    minHeight: 900,
    maxBytes: 300_000,
  ...
  {
    path: 'docs/assets/agentganggang-settings.png',
    type: 'png',
    minWidth: 1200,
    minHeight: 900,
    maxBytes: 300_000,
  ...
  {
    path: 'docs/assets/agentganggang-demo.gif',
    type: 'gif',
    minWidth: 1200,
    minHeight: 760,
    maxBytes: 800_000,
  ...
  {
    path: 'docs/assets/agentganggang-workflow.svg',
    type: 'svg',
    width: 1280,
    height: 720,
    maxBytes: 45_000,
