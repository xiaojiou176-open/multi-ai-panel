...
const assetSpecs = [
  {
    path: 'docs/assets/multi-ai-panel-social-preview.png',
    type: 'png',
    width: 1280,
    height: 640,
    maxBytes: 1_000_000,
  ...
  {
    path: 'docs/assets/multi-ai-panel-nav-icon.svg',
    type: 'svg',
    width: 128,
    height: 128,
    maxBytes: 10_000,
  ...
  {
    path: 'docs/assets/multi-ai-panel-before-after.svg',
    type: 'svg',
    width: 1280,
    height: 780,
    maxBytes: 30_000,
  ...
  {
    path: 'docs/assets/multi-ai-panel-hero.png',
    type: 'png',
    minWidth: 1600,
    minHeight: 900,
    maxBytes: 600_000,
  ...
  {
    path: 'docs/assets/multi-ai-panel-compare-detail.png',
    type: 'png',
    minWidth: 1200,
    minHeight: 700,
    maxBytes: 400_000,
  ...
  {
    path: 'docs/assets/multi-ai-panel-workflow-panel.png',
    type: 'png',
    minWidth: 1200,
    minHeight: 300,
    maxBytes: 250_000,
  ...
  {
    path: 'docs/assets/multi-ai-panel-analyst-panel.png',
    type: 'png',
    minWidth: 1200,
    minHeight: 900,
    maxBytes: 250_000,
  ...
  {
    path: 'docs/assets/multi-ai-panel-builder-surface.png',
    type: 'png',
    minWidth: 900,
    minHeight: 900,
    maxBytes: 300_000,
  ...
  {
    path: 'docs/assets/multi-ai-panel-settings.png',
    type: 'png',
    minWidth: 1200,
    minHeight: 900,
    maxBytes: 300_000,
  ...
  {
    path: 'docs/assets/multi-ai-panel-demo.gif',
    type: 'gif',
    minWidth: 1200,
    minHeight: 760,
    maxBytes: 800_000,
  ...
  {
    path: 'docs/assets/multi-ai-panel-workflow.svg',
    type: 'svg',
    width: 1280,
    height: 720,
    maxBytes: 45_000,
