...
- Codex and Claude Code:
  ...
  - no official MultiAiPanel marketplace listing verified from current official docs
- OpenCode:
...
- OpenClaw:
  ...
  - no official MultiAiPanel listing is verified from the checked OpenClaw docs
...
- root-level `multi-ai-panel-*.tgz` files are disposable leftovers, not the
