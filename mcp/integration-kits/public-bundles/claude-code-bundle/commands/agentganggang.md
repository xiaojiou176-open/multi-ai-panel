...
Use MultiAiPanel when you want Claude Code to compare one prompt across
multiple supported AI chat tabs through the local MultiAiPanel MCP
surface.
...
- This bundle assumes Claude Code already knows how to launch the local MultiAiPanel MCP server.
