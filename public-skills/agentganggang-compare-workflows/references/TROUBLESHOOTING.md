...
- the MultiAiPanel browser extension is installed and enabled
...
1. rerun `multi-ai-panel.bridge_status`
2. rerun `multi-ai-panel.check_readiness`
3. if the skill supports it, use `multi-ai-panel.retry_failed`
...
MultiAiPanel is a local browser workflow with a local MCP sidecar. This
